...
class Lista(IPersistencia):
    ...
    def diccionario_a_objeto(self, diccionario_listas: dict):
        try:
            if (
                "Descripción" in diccionario_listas
                and diccionario_listas["Descripción"]
            ):
            ...
            if (
                "Lista de canciones" in diccionario_listas
                and diccionario_listas["Lista de canciones"]
            ):
                self.set_lista_canciones(diccionario_listas["Lista de canciones"])

            if (
                "Fecha de creación" in diccionario_listas
                and diccionario_listas["Fecha de creación"]
            ):
