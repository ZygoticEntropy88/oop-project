...
class Fecha:
    ...
    def __str__(self):
        ...
        fecha_formato_reducido += f"0{self.get_dia()}" if self.get_dia() < 10 else f"{self.get_dia()}"
        fecha_formato_reducido += "/"
        fecha_formato_reducido += f"0{self.get_mes().value}" if self.get_mes().value < 10 else f"{self.get_mes().value}"
        fecha_formato_reducido += "/"
