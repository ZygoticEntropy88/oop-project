...
class Lista(IPersistencia):
    ...
    def objeto_a_diccionario(self):
        ...
        if self.get_lista_canciones():
            diccionario_listas["Lista canciones"] = [
                cancion.objeto_a_diccionario() for cancion in self.get_lista_canciones()
            ]
    ...
    def diccionario_a_objeto(self, diccionario_listas: dict):
        try:
            if (
                "Nombre lista" in diccionario_listas
                and diccionario_listas["Nombre lista"]
            ):
                self.set_nombre(diccionario_listas["Nombre lista"])

            if (
                "Descripcion" in diccionario_listas
                and diccionario_listas["Descripcion"]
            ):
                self.set_descripcion(diccionario_listas["Descripcion"])

            if (
                "Lista canciones" in diccionario_listas
                and diccionario_listas["Lista canciones"]
            ):
            ...
            if (
                "Fecha creacion" in diccionario_listas
                and diccionario_listas["Fecha creacion"]
            ):
            ...
            if (
                "Usuario creador" in diccionario_listas
                and diccionario_listas["Usuario creador"]
            ):
